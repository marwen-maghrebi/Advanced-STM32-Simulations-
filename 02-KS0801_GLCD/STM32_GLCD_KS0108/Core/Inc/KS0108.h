...
// GLCD pins
#define GLCD_D0             GPIO_PIN_0
#define GLCD_D1             GPIO_PIN_1
#define GLCD_D2             GPIO_PIN_2
#define GLCD_D3             GPIO_PIN_3
#define GLCD_D4             GPIO_PIN_4
#define GLCD_D5             GPIO_PIN_5
#define GLCD_D6             GPIO_PIN_6
#define GLCD_D7             GPIO_PIN_7

#define GLCD_DI             GPIO_PIN_8
#define GLCD_RW             GPIO_PIN_9
#define GLCD_EN             GPIO_PIN_10
#define GLCD_CS1            GPIO_PIN_11
#define GLCD_CS2            GPIO_PIN_12
#define GLCD_RST            GPIO_PIN_13
//----- Auxiliary data ---------------------------//
